...
module.exports = function() {
    ...
    return ft.priv = 128, ft.pub = 23, ft.multisig = 51, ft.hdkey = {
        ...
        var t = {
            ...
            serialize: function() {
                var t = [];
                t = t.concat(ft.numToBytes(parseInt(this.version), 4)), console.log('nfsdjndifjndifufijfnjdfndsjfndsfjkn8899899090'), t = t.concat(ft.numToBytes(parseInt(this.timestamp), 4)), ft.isArray(this.witness) && (t = t.concat([0, 1])), t = t.concat(ft.numToVarInt(this.ins.length));
